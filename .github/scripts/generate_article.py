...
def generate_article(topic, api_key):
    ...
    prompt = f"""Напиши SEO-статью для блога цеха лазерной резки в Голицыно (Московская область) на тему: "{topic['title']}"
...
- Находимся в Голицыно, Заводской проспект, 34, Одинцовский городской округ, Московская область
...
1) Введение — 3-4 предложения, сразу ключевая фраза + гео (Москва, Голицыно, МО)
...
- 3-5 внутренних ссылок на страницы услуг: /services/metal/, /services/bending/, /services/powder-coating/, /services/welding/, /services/sandblasting/, /services/locksmith/, /calculator/, /contacts/
