...
- Находимся в Голицыно (Московская область), 25 км от МКАД
...
{{
  ...
  "description": "Мета-описание 140-160 символов, с цифрами и CTA. Заканчивается на 'Цех в Голицыно, Москва и МО.'",
  "slug": "{topic['slug']}",
