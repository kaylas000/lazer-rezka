...
function getAutoResponse(message) {
  ...
  if (lower.includes('позвон') || lower.includes('менедж') || lower.includes('человек')) {
    return 'Оставьте ваш телефон в форме на сайте, и наш менеджер перезвонит в течение 1 часа (пн-пт 8:00-18:00). Или звоните: +7 (985) 456-37-64';
  }
  
  return 'Спасибо за вопрос! Для детальной консультации позвоните нам: +7 (985) 456-37-64 или оставьте заявку на сайте.';
}
